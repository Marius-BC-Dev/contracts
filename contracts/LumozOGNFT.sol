...
contract LumozOGNFT is Initializable, ERC721EnumerableUpgradeable, PausableUpgradeable, AccessControlUpgradeable {
    ...
    function initialize(address defaultAdmin, string memory _name, string memory _symbol) initializer public {
        ...
        levels[OGLevel.Basic] = 200 ether;
        levels[OGLevel.Mid]   = 1000 ether;
        levels[OGLevel.High]  = 5000 ether;
    }
